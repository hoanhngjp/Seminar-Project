...
INSERT INTO song_genres ("SongId", "GenreId", "CreatedAt") VALUES
  ...
  ('b0000001-0000-0000-0000-000000000001', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000001', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 2: Anh Nhớ Ra — Indie, Pop
  ('b0000001-0000-0000-0000-000000000002', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000002', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 3: Anh Nhớ Ra (Live Solo) — Acoustic, Indie
  ('b0000001-0000-0000-0000-000000000003', 'e1f2a3b4-c5d6-7890-efab-123456789012'),
  ('b0000001-0000-0000-0000-000000000003', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  -- 4: An Thần — Hip-Hop
  ('b0000001-0000-0000-0000-000000000004', 'd0e1f2a3-b4c5-6789-defa-012345678901'),
  -- 5: Bút Chì Bạc — Indie, Acoustic
  ('b0000001-0000-0000-0000-000000000005', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000005', 'e1f2a3b4-c5d6-7890-efab-123456789012'),
  -- 6: Bước Qua Nhau — Indie, Pop
  ('b0000001-0000-0000-0000-000000000006', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000006', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 7: Chúng Ta Không Thuộc Về Nhau — Pop, Electronic
  ('b0000001-0000-0000-0000-000000000007', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  ('b0000001-0000-0000-0000-000000000007', 'c9d0e1f2-a3b4-5678-cdef-901234567890'),
  -- 8: Chậm Lại — Indie, Pop
  ('b0000001-0000-0000-0000-000000000008', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000008', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 9: Ending Interlude — Electronic
  ('b0000001-0000-0000-0000-000000000009', 'c9d0e1f2-a3b4-5678-cdef-901234567890'),
  -- 10: Ghé Qua — Hip-Hop
  ('b0000001-0000-0000-0000-000000000010', 'd0e1f2a3-b4c5-6789-defa-012345678901'),
  -- 11: Gội Đầu — Indie, Rock
  ('b0000001-0000-0000-0000-000000000011', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000011', 'e5f6a7b8-c9d0-1234-efab-567890123456'),
  -- 12: Intro 2022 — Electronic
  ('b0000001-0000-0000-0000-000000000012', 'c9d0e1f2-a3b4-5678-cdef-901234567890'),
  -- 13: Lạ Lùng — Indie, Pop
  ('b0000001-0000-0000-0000-000000000013', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000013', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 14: Chuyển Kênh — Indie, Rock
  ('b0000001-0000-0000-0000-000000000014', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000014', 'e5f6a7b8-c9d0-1234-efab-567890123456'),
  -- 15: Lần Cuối — Indie, Pop
  ('b0000001-0000-0000-0000-000000000015', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000015', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 16: Những Lời Hứa Bỏ Quên — Pop
  ('b0000001-0000-0000-0000-000000000016', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 17: No Need — R&B
  ('b0000001-0000-0000-0000-000000000017', 'f6a7b8c9-d0e1-2345-fabc-678901234567'),
  -- 18: Nơi Này Có Anh — Pop
  ('b0000001-0000-0000-0000-000000000018', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 19: Nếu Những Tiếc Nuối — Indie, Pop
  ('b0000001-0000-0000-0000-000000000019', 'f2a3b4c5-d6e7-8901-fabc-234567890123'),
  ('b0000001-0000-0000-0000-000000000019', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 20: #MusicForM — Hip-Hop
  ('b0000001-0000-0000-0000-000000000020', 'd0e1f2a3-b4c5-6789-defa-012345678901'),
  -- 21: Stay with Me (Night Tempo Mix) — Electronic, Pop
  ('b0000001-0000-0000-0000-000000000021', 'c9d0e1f2-a3b4-5678-cdef-901234567890'),
  ('b0000001-0000-0000-0000-000000000021', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 22: Cơn Mưa Xa Dần — Pop, R&B
  ('b0000001-0000-0000-0000-000000000022', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  ('b0000001-0000-0000-0000-000000000022', 'f6a7b8c9-d0e1-2345-fabc-678901234567'),
  -- 23: Nắng Ấm Ngang Qua — Pop, R&B
  ('b0000001-0000-0000-0000-000000000023', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  ('b0000001-0000-0000-0000-000000000023', 'f6a7b8c9-d0e1-2345-fabc-678901234567'),
  -- 24: Mây Lang Thang — Hip-Hop
  ('b0000001-0000-0000-0000-000000000024', 'd0e1f2a3-b4c5-6789-defa-012345678901'),
  -- 25: Waiting For — R&B
  ('b0000001-0000-0000-0000-000000000025', 'f6a7b8c9-d0e1-2345-fabc-678901234567'),
  -- 26: Bản Tình Ca Không Hoàn Thiện (Live) — Hip-Hop, Acoustic
  ('b0000001-0000-0000-0000-000000000026', 'd0e1f2a3-b4c5-6789-defa-012345678901'),
  ('b0000001-0000-0000-0000-000000000026', 'e1f2a3b4-c5d6-7890-efab-123456789012'),
  -- 27: Linh Hồn Của Bữa Tiệc (Live) — Hip-Hop
  ('b0000001-0000-0000-0000-000000000027', 'd0e1f2a3-b4c5-6789-defa-012345678901'),
  -- 28: Thôi Trễ Rồi (Live) — Hip-Hop
  ('b0000001-0000-0000-0000-000000000028', 'd0e1f2a3-b4c5-6789-defa-012345678901'),
  -- 29: Âm Thầm Bên Em — Pop
  ('b0000001-0000-0000-0000-000000000029', 'd4e5f6a7-b8c9-0123-defa-234567890123'),
  -- 30: 真夜中のドア〜Stay with Me — Electronic, Pop
  ('b0000001-0000-0000-0000-000000000030', 'c9d0e1f2-a3b4-5678-cdef-901234567890'),
  ('b0000001-0000-0000-0000-000000000030', 'd4e5f6a7-b8c9-0123-defa-234567890123', NOW())
...
INSERT INTO song_artists ("SongId", "ArtistId", "DisplayName", "Role", "DisplayOrder") VALUES
  -- All primary artists
  ('b0000001-0000-0000-0000-000000000001', 'a0000001-0000-0000-0000-000000000001', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000002', 'a0000001-0000-0000-0000-000000000001', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000003', 'a0000001-0000-0000-0000-000000000001', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000004', 'a0000001-0000-0000-0000-000000000007', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000005', 'a0000001-0000-0000-0000-000000000008', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000006', 'a0000001-0000-0000-0000-000000000001', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000007', 'a0000001-0000-0000-0000-000000000002', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000008', 'a0000001-0000-0000-0000-000000000001', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000009', 'a0000001-0000-0000-0000-000000000005', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000010', 'a0000001-0000-0000-0000-000000000009', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000011', 'a0000001-0000-0000-0000-000000000008', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000012', 'a0000001-0000-0000-0000-000000000002', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000013', 'a0000001-0000-0000-0000-000000000001', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000014', 'a0000001-0000-0000-0000-000000000003', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000015', 'a0000001-0000-0000-0000-000000000003', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000016', 'a0000001-0000-0000-0000-000000000001', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000017', 'a0000001-0000-0000-0000-000000000005', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000018', 'a0000001-0000-0000-0000-000000000002', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000019', 'a0000001-0000-0000-0000-000000000001', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000020', 'a0000001-0000-0000-0000-000000000011', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000021', 'a0000001-0000-0000-0000-000000000006', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000022', 'a0000001-0000-0000-0000-000000000002', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000023', 'a0000001-0000-0000-0000-000000000002', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000024', 'a0000001-0000-0000-0000-000000000010', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000025', 'a0000001-0000-0000-0000-000000000005', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000026', 'a0000001-0000-0000-0000-000000000004', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000027', 'a0000001-0000-0000-0000-000000000004', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000028', 'a0000001-0000-0000-0000-000000000004', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000029', 'a0000001-0000-0000-0000-000000000002', NULL, 'primary', 0),
  ('b0000001-0000-0000-0000-000000000030', 'a0000001-0000-0000-0000-000000000006', NULL, 'primary', 0),

  -- Featured artists (collab songs)
  -- Song 2: Anh Nhớ Ra — Trang (featured)
  ('b0000001-0000-0000-0000-000000000002', 'a0000001-0000-0000-0000-000000000012', NULL, 'featured', 1),
  -- Song 4: An Thần — Thắng (featured)
  ('b0000001-0000-0000-0000-000000000004', 'a0000001-0000-0000-0000-000000000008', NULL, 'featured', 1),
  -- Song 10: Ghé Qua — Tofu, PC (featured)
  ('b0000001-0000-0000-0000-000000000010', 'a0000001-0000-0000-0000-000000000015', NULL, 'featured', 1),
  ('b0000001-0000-0000-0000-000000000010', 'a0000001-0000-0000-0000-000000000011', NULL, 'featured', 2),
  -- Song 16: Những Lời Hứa Bỏ Quên — Dear Jane (featured)
  ('b0000001-0000-0000-0000-000000000016', 'a0000001-0000-0000-0000-000000000013', NULL, 'featured', 1),
  -- Song 21: Stay with Me (Night Tempo Mix) — Night Tempo (featured)
  ('b0000001-0000-0000-0000-000000000021', 'a0000001-0000-0000-0000-000000000014', NULL, 'featured', 1),
  -- Song 24: Mây Lang Thang — PC, NewoulZ (featured)
  ('b0000001-0000-0000-0000-000000000024', 'a0000001-0000-0000-0000-000000000011', NULL, 'featured', 1),
  ('b0000001-0000-0000-0000-000000000024', 'a0000001-0000-0000-0000-000000000016', NULL, 'featured', 2)
